...
This plan supports three upper-elementary fictional composite students during inclusive STEM and Computer Science teaching routines and the home--school transition that follows them. Each student represents a puzzle piece in my Puzzle Plan and a puzzle piece in a learner's own life: Mateo represents neurodivergence, culture, and language; Eli represents neurodivergence and speech/multimodal access; and Luca represents neurodivergence, chronic illness, low speech, and speech-related trauma. The profiles are fictional, but the support strategies are grounded in de-identified EDU486 camp evidence, K--5 teaching-placement evidence, and prior EDE448 work on access, agency, dignity, consent, and neurodiversity. A multiple-student composite design lets me examine how nonspeaking, low-speaking, bilingual, health-affected, and speech-unreliable communication profiles require different supports while sharing the same core principle: a student's speech should not be the price of participation. The goal is reliable authorship; each learner needs ways to initiate, refuse, repair, ask, comment, joke, explain, choose a role, protect sensory and body boundaries, influence the activity, and decide what information travels home.
...
\begin{longtable}{>{\RaggedRight\arraybackslash}p{0.55in} >{\RaggedRight\arraybackslash}p{3.05in} >{\RaggedRight\arraybackslash}p{3.45in}}
...
Teaching-placement evidence directly informs Mateo's profile. In one of my computer science teaching lesson, a student (Mateo) interface appeared in Spanish during stepwise editing support. The interaction continued through visual demonstration, pointing, and short directions; the student (Mateo) completed the editing step and the group moved into successful production work during the same session. EDU486 camp evidence informs Eli and Luca. Youth could identify current energy, self-select meaningful roles such as commentator, and participate through measuring, observing, writing, pointing, photographing, partnering, voting, passing, returning, and revising shared models. Those are communication routes, not extra accommodations.
...
\begin{longtable}{>{\RaggedRight\arraybackslash}p{1.25in} >{\RaggedRight\arraybackslash}p{2.40in} >{\RaggedRight\arraybackslash}p{0.60in} >{\RaggedRight\arraybackslash}p{2.75in}}
\tableheaderfour{Practice}{Instructional Meaning}{Student}{Planned Safeguard}
Stepwise technology support & Visual demonstration and short directions preserved progress during interface complexity. & Mateo & Screenshots, bilingual labels, one visible step, AAC/typing response, and interface-language checks. \\

\rowcolor{SoftGray}
Youth-selected role & A meaningful role opened a communication route and gave the learner social purpose. & Eli & Commentator, evidence finder, photographer, demonstrator, observer/returner, and other flexible roles. \\

Energy and health check & Current body state informed access while competence remained visible. & Luca & Tired/pain/private/no voice today options, lower-output participation, rest, and planned re-entry. \\

\rowcolor{SoftGray}
Model revision and advocacy & Student contributions changed shared products and decisions. & All & Communication must alter pace, role, tool, question, material, record, or next instructional decision. \\
\end{longtable}
\normalsize
...
One camp-based pattern also needs to be included in the plan: adult partners' behavior can either invite communication or shut it down. In de-identified records and field reflection, rigid adult direction, premature suggestions, long teacher talk, visible frustration, correcting by taking over materials, and returning to students while dysregulated functioned as access barriers. EQUITAS requires me to ask how power, race, disability, health, language, and adult authority shape what students feel safe enough to communicate. The teaching lesson is direct: students need adults who regulate themselves before regulating the activity. A communication plan cannot only train the student to produce clearer messages. It must train educators to ask before suggesting, protect student authorship, avoid undoing student work, notice fear and shutdown as data, and repair when adult behavior reduces safety. For Black, CLD, neurodivergent, chronically ill, or low-speaking students, adult escalation can carry extra threat because the student may not have equal social-power or access to explanation.
...
\begin{longtable}{>{\RaggedRight\arraybackslash}p{1.00in} >{\RaggedRight\arraybackslash}p{2.80in} >{\RaggedRight\arraybackslash}p{3.20in}}
...
\caption{The fictional learners show that AAC planning must connect language, speech access, health, partner behavior, and home continuity instead of treating communication as a device-only problem.}
...
\begin{longtable}{>{\RaggedRight\arraybackslash}p{0.80in} >{\RaggedRight\arraybackslash}p{3.45in} >{\RaggedRight\arraybackslash}p{2.85in}}
...
The supplied \textit{Daily Communication Logs} packet provides many school--home formats. This plan uses a record that carries student meaning, language, context, health access, and family knowledge across settings.
...
Wait time, no-touch/no-undo practice, adult affect, control of materials, idea retention &
Adult behavior reduces student voice, initiative, or ownership. \\
